document.addEventListener("DOMContentLoaded", function (e) {
    ...
    const info = {
            description: '' +
                'На этой странице можно поддержать улучшения, предложенные пользователями редактора, которые вы хотели бы видеть в обновлениях.<br/>' +
                'Именно благодаря активности участников в редакторе появилось большинство существующих блоков, настроек и возможностей.<br/>' +
                'Примеры улучшений на вкладке <a href="https://marketplace.1c-bitrix.ru/solutions/sprint.editor/#tab-log-link" target="_blank">Что нового</a><br/>' +
                '<br/><br/>' +
                'Предложить свою идею по улучшению можно в <a href="https://t.me/sprint_editor" target="_blank">telegram-группе</a> ' +
                'или на вкладке <a href="https://marketplace.1c-bitrix.ru/solutions/sprint.editor/#tab-comments-link" target="_blank">Обсуждения</a><br/>' +
            ...
            items: [
                {
                    title: "[Закрыто] Интеграция с Flickr",
